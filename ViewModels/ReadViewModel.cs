...
namespace MobiHymnMaui.ViewModels
{
    public class ReadViewModel : BaseViewModel
    {
        ...
        #region Properties
        private static ReadViewModel instance = null;
        public static ReadViewModel Instance
        {
            get
            {
                instance ??= new ReadViewModel();
                return instance;
            }
        }
        ...
        public ICommand FontSelected
        {
            get
            {
                return fontSelected ?? (fontSelected = new Command<string>((fontName) =>
                {
