...
namespace MobiHymnMaui.ViewModels
{
    public class BookmarksViewModel : BaseViewModel
    {
        ...
        public ICommand BookmarkGroupSelected
        {
            get
            {
                return bookmarkGroupSelected ?? (bookmarkGroupSelected = new Command<string>(async (key) =>
                {
        ...
        public ICommand BookmarkSelected
        {
            get
            {
                return bookmarkSelected ?? (bookmarkSelected = new Command<ShortHymn>(async (shortHymn) =>
                {
